...
- **触发与计数**：已知竞品 = 本次抽取的品牌 scope `competitors` 值 ∪ KnowledgeAuthority 中该 fact key 的已确认权威值；目标 10 家（ranking 需要 5 家，多给 5 家备选供用户判断）。产品线 scope 竞品计入去重但不计入品牌目标。
