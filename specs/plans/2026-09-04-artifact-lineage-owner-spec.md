...
> 状态：立项票已落地（4e45b39，分支 geo/artifact-lineage-owner——owner＋守卫棘轮 27 项豁免＋删除原因词表双侧 pin，纯增量全绿）；清零样板票 02 baseline 已落地（60d2aaf——2 写点经 owner、from 规则按真实代码钉进 `allowed_from`、豁免表消 2 项余 25，等价全绿 cargo 472＋npm 156）；其余清零票（issues/03-08）待开
